...
\item Is the \emph{Security Policy Template: Use of Handheld Devices
  ...
  legislation.
\item Is from the \ac{HiMSS}; a US non-profit company trying to
  improve healthcare through
  IT~\cite{healthcare_information_and_management_systems_society_mobile_2012}. The
...
check if it satisfied~\cite{joseph_hallett_capturing_2017}; to
