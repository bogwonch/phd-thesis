...
\begin{equation*}
 AC, D \models \texttt{\mathit{A} says \mathit{fact}.} 
...
point. %Whatever relationship the entities have, SecPAL can describe it.
...
add a $\forall$ and $\exists$ statement for queries. This allowed it to answer
