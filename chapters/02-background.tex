...
common use case for these logics is building access control systems. A
user is allowed to read a file if he or she has the proper
permissions. In applying logics of authorization to policy language
...
\emph{can-act-as} verbs) and arbitrary constraints. Delegation lets a
...
of an assertion is equivalent to another: effectively aliasing the
...
guarantees and fast evaluation. It is similar Prolog. They also showed
