...
\todo{
  ...
  AC, D |= A says B has X.
  ----------------------------------------------------
  P(\exists AC_past st. AC_past, D_past |= A says B can X.)

  AC, D |= A says B must X.  F(AC, D |= A says B can X).
  ------------------------------------------------------
  F(\exist R in AC of the form A says B has X...)


  Possible applications to conststency checking AC over time? Compression?
}
