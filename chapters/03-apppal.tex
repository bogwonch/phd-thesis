...
This differs from the approach taken with SecPAL4P and SecPAL4DSA~\cite{becker_framework_2009,aziz_secpal4dsa:_2011}.
...
X says A predicate(B, C) 
  if A isT1, 
     ...
     ... .
\end{lstlisting}
  \caption{Desugaring from AppPAL types to SecPAL.}
...
is future work to evaluate how AppPAL policies mgiht work in practice and be
...
Pseudocode for evaluation algorithm used by AppPAL is described
...
completeness. If AppPAL were encorporated into a production system, the
...
minutes, may likely be enough for many scenarios.

The arguments in thes rest of the section assume that the result of evaluating a
...
also be sound as they are analogus to the \emph{can-say} and \emph{can-act-as}
...
\texttt{Cond} function returns success. Since this process is analogus to the
...
\todo{Recap properties quickly here.}
