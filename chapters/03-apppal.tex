...
Datalog~\cite{alon_levy_equivalence_1993,alon_levy_constraints_1992}, exist.
Researchers have thought about how policies can be checked for various
properties similar to those described here. The properties we seek to check
AppPAL (or SecPAL) for are not novel, but rather the application of them to
SecPAL is. We have implemented preliminary checkers for some of these
properties, though they are undertested. The code is included with AppPAL.
