...
\newcommand{\descPred}[2]{\emph{subject} \texttt{\textbf{#2}\emph{#3}}}
\begin{table}
  \begin{tabular}{l l}
    \toprule
    Prefix                        & Meaning                                            \\
    ...
    \desc{Pred}{is}{Property}     & The property holds true for the subject.           \\
    \desc{Pred}{must}{Obligation} & The subject is required to satisfy the obligation. \\
    \bottomrule
    \midrule
  \end{tabular}
