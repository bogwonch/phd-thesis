...
An alternative language could have been XACML.  XACML is a standardised policy language~\cite{oasis_extensible_2013} that can be extended to fit many scenarios.  It is an attribute based policy language, but can also role-based policies.  It has industrial support from \emph{Oracle}.
