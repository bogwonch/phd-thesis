...
\subsection{Expressing differences between markets using AppPAL}.
...
To compare some of the different policies in the stores we read and described parts of these policies using SecPAL.
This allows for a more precise comparison between the different stores.
