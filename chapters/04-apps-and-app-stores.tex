...
This policy is very simple (it essentially just whitelists apps) but
...
remainder.  The output of the tool, and the webapp it creates is shown
in \autoref{fig:genstore-output}.
Alice can take this webapp and modify it to work in her company.
...
[INFO] copying apks
\end{Verbatim}
  \caption[Output of the GenStore tool.]{Output of the GenStore tool which runs on the command-line and produces a webapp.}
