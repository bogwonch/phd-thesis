...
the terms and conditions between the various marketplaces. We look at how users have privacy preferences
about the which apps they want to use. But by using AppPAL versions of common
user privacy preferences, we show how Android users do not seem to follow them in
...
a feature: Amazon does this with their Kindle Fire tablets, where Kindle owners
